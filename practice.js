...
function looper(arr){
  for (let i = 0; i < arr.length; i++){
    let curr = arr[i]
    //remember it says should CALL ALERT
      //dont return just call alert
    alert(curr)
  }
}
////////// PROBLEM 4 //////////
...
// function divider (numbersArray){
//   evens = numbersArray.filter(x => {
//     return x % 2 === 0
//   })
//   odds = numbersArray.filter(x => {
//     return x % 2 !== 0
//   })
//   return [evens, odds]
// }
...
// function removeItem (myGroceryList, item){
// return myGroceryList.filter(list => {
//   return list !== item
//  })
// }
...
function removeItem (myGroceryList, arr){
  return myGroceryList.filter(x => {
    return x !== arr
  })
}
